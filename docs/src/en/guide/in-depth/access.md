...
With the permission codes, you can use the `AccessControl` component and API provided by `@kris/access` to show and hide buttons.

#### Component Method

```vue
<script lang="ts" setup>
import { AccessControl, useAccess } from '@kris/access';
...
```vue
<script lang="ts" setup>
import { AccessControl } from '@kris/access';
</script>
...
```vue
<script lang="ts" setup>
import { useAccess } from '@kris/access';
