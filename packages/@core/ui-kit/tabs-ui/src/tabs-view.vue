...
import { useForwardPropsEmits } from '@kris-core/composables';
import { ChevronLeft, ChevronRight } from '@kris-core/icons';
import { KrisScrollbar } from '@kris-core/shadcn-ui';
