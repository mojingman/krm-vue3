...
import type { KrisButtonProps } from '@kris-core/shadcn-ui';
import type { ClassType, MaybeComputedRef } from '@kris-core/typings';
...
export interface ActionButtonOptions extends KrisButtonProps {
  [key: string]: any;
  content?: MaybeComputedRef<string>;
  show?: boolean;
}

export interface KrisFormProps<
  T extends BaseFormComponentType = BaseFormComponentType,
> extends Omit<
    FormRenderProps<T>,
...
export type ExtendedFormApi = FormApi & {
  useStore: <T = NoInfer<KrisFormProps>>(
    selector?: (state: NoInfer<KrisFormProps>) => T,
  ) => Readonly<Ref<T>>;
};

export interface KrisFormAdapterOptions<
  T extends BaseFormComponentType = BaseFormComponentType,
> {
  config?: {
