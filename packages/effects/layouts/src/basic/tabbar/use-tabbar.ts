...
import type { TabDefinition } from '@kris/types';

import type { IContextMenuItem } from '@kris-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@kris/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { getTabKey, useAccessStore, useTabbarStore } from '@kris/stores';
import { filterTree } from '@kris/utils';
